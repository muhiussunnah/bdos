...
export default function ContactPage() {
  ...
  function submit(e: React.FormEvent) {
    ...
    window.location.href = `mailto:support@klientic.com?subject=${subject}&body=${body}`;
  }
      ...
      <div className="mx-auto grid max-w-5xl gap-12 px-5 md:grid-cols-2">
        <div>
          ...
          <div className="mt-8 space-y-4">
            <a href="mailto:support@klientic.com" className="flex items-center gap-3 rounded-2xl border border-[#ECEAF1] p-4 transition hover:border-[#A435E8]">
              ...
              <div><div className="text-[14px] font-bold text-[#16121F]">Email us</div><div className="text-[13px] text-[#6A6478]">support@klientic.com</div></div>
            </a>
